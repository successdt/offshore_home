...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page( __('Theme Options','doover'), __('Theme Options','doover'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
?>
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
			<input type="submit" class="button-primary" name="update" value="<?php _e('Save Options','doover'); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php _e('Restore Defaults','doover'); ?>" onclick="return confirm( '<?php print esc_js( __('Click OK to reset. Any theme settings will be lost!','doover') ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'doover' ), 'updated fade' );
	...
	if ( isset( $_POST['update'] ) ) {
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'doover' ), 'updated fade' );
		return $clean;	
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __('Theme Options','doover'),
		'href' => admin_url( 'themes.php?page=options-framework' )
  ));
}

if ( ! function_exists( 'doover_get_option' ) ) {
	...
	function doover_get_option( $name, $default = false, $force_default = false ) {
