				...
				<table class="content-inner">
					...
					<tbody >
						<tr>
							...
							<td>
								<?php 
									if(isset($userdata['User']['last_login'])){
										echo $userdata['User']['last_login'];
									}else{
										echo "None";									
									}
								?>
						...
						<tr>
							...
							<td>
								<?php 
									if(isset($data['Config']['stop_auto'])){
										if($data['Config']['stop_auto'] == 1){
											echo "Stopped";
										}else{
											echo "Auto Running";
										}
						...
						<tr>
							<td>Total Number Searched</td>
							<td>
								<?php 
									if(isset($reportdata['Report']['total_search'])){
										echo $reportdata['Report']['total_search'];
									}else{
										echo "None";									
									}
								?>
						...
						<tr>
							...
							<td>
								<?php 
									if(isset($reportdata['Report']['last_search'])){
										echo $reportdata['Report']['last_search'];
									}else{
										echo "None";									
									}
								?>
